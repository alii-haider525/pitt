...
export default function page() {
    return (
        <div className="container mx-auto px-2 py-16 flex md:flex-row flex-col w-full gap-4">
            <div className=''>
                <div className='md:w-[19rem] text-center md:text-start px-2 md:px-0'>
                    ...
                    <button className="mt-6 md:px-6 px-3 py-3 text-primaryRed border-red-500  border-[1px] hover:text-secondary rounded-md hover:bg-red-600">
                        Learn More
                    </button>
                </div>

            </div>
            <div className="flex gap-6 pl-6 md:gap-2 items-center justify-center flex-col md:flex-row w-full">
                <div className="md:w-[16rem] rounded-md ">
